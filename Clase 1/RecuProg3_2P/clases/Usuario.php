...
//--METODO DE CLASE
    public static function TraerUsuarioLogueado($obj)
    {
        ...
        $sql = "SELECT U.id, U.nombre, U.email, U.perfil, U.foto, U.password FROM usuarios U WHERE U.email = :email AND U.password = :pass";
    ...
    public static function Modificar($obj)
    {
        ...
        $sql = "UPDATE usuarios SET nombre = :nombre, email = :email, password = :pass, perfil = :perfil, foto = :foto 
                WHERE id = :id";
